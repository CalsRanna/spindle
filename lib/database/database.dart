...
import 'package:spindle/database/migration/migration_202601161200.dart';
...
''';
  ...
  Future<void> ensureInitialized() async {
    ...
    var path = join(directory.path, 'spindle.db');
    var file = File(path);
  ...
  Future<void> _migrate() async {
    ...
    await Migration202601161200().migrate(laconic);
  }
}
